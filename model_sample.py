...
if __name__ == "__main__":
    ...
    # generator = TextGenerator(checkpoint='./model/pretrain_1024_18_6144.pth')  # 初始化生成器
    for i in range(len(pretrain_prompt_datas)):
        samples = generator.pretrain_sample(start=pretrain_prompt_datas[i], num_samples=1, max_new_tokens=128, temperature=0.7)
